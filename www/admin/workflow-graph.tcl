...
if { [wf_graphviz_installed_p] } {
    ...
    set workflow_img_tag "<img src=\"/[im_workflow_url]/workflow-gif?[export_vars -url { tmpfile}]\" border=0 $width_and_height alt=\"Graphical representation of the process network\">"
} else {
